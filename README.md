...
<img src="https://img.shields.io/badge/Discord-Karaoke-5865F2?logo=discord&logoColor=white" alt="Discord">
<img src="https://img.shields.io/badge/Audio-pedalboard-9ece6a" alt="pedalboard">
</p>

<p align="center">
<img src="docs/screenshot.png" width="820" alt="Discord Karaoke 스크린샷">
</p>

## 동작 원리

<p align="center">
<img src="docs/architecture.svg" width="900" alt="동작 원리 다이어그램">
</p>

## 🚀 3분 만에 시작하기

<p align="center">
<img src="docs/quickstart.svg" width="900" alt="3단계 빠른 시작 가이드">
</p>
...
링크만 붙여넣으면 오디오(mp3)와 가사 영상(mp4)을 함께 저장
...
노래방 MR 영상의 가사·진행 표시를 메인 창에서 동기 재생
...
음정 ±6반음 / 속도 0.5~1.5x 독립 조절 (pedalboard time_stretch)
...
프리셋(노래방/콘서트홀/동굴) + 세부 조절(딜레이/피드백/믹스/리버브)
...
WASAPI 자동 선택, 지터 버퍼 클럭 드리프트 보상, 피크 리미터
...
마이크 무음 감지, 자동 감지, 장치 샘플레이트 불일치 경고, `--selftest` 모드
